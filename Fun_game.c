...
int main(){
	...
	element nature = {"e Nature",6,-1,0,1,1,"Est soign̩ de 1PV par tour et reduit les degats subits de 1 a chaque attaque"};
	...
	// Ce tableau contient 20 cartes, c'est donc un deck, /! Les cartes sont tri̩es donc quand on piochera il faudra prendre une carte al̩atoire parmi le deck
	...
	//Pour r̩cup̩rer une carte il faut "deck1[rang voulu]"
	//On peut ainsi afficher le nom de la 13̬me carte du deck par exemple :
	printf ("%s\n",deck[12].Entity.Name);
